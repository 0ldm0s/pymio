...
from mio.sys.flask_mongoengine.pagination.basic_pagination import Pagination
...
class KeysetPagination(Pagination):
    ...
    def get_page(
            self, iterable, per_page: int, field_filter_by: str = '_id', last_field_value=None, direction='forward'):
